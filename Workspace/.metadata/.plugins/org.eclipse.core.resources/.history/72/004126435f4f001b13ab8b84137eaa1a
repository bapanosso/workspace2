...
public class TipoString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Posição do caracter: " + email.indexOf("@"));
		System.out.println("Do 2° até o 5° caracter: " + email.substring(1,4));
		System.out.println("A partir do 3° caracter: " + email.substring(2, email.length()));
		System.out.println("Do 2° até o 5° caracter: " + email.substring(0, email.indexOf("@")));
